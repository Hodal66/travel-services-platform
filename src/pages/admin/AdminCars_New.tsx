...
const AdminCars: React.FC = () => {
  ...
  const carColumns: ColumnConfig[] = [
    { key: 'brand', label: 'Brand', isVisible: true, isRequired: true },
    { key: 'model', label: 'Model', isVisible: true, isRequired: true },
    { key: 'category', label: 'Category', isVisible: true, isRequired: true },
    { key: 'location', label: 'Location', isVisible: true, isRequired: true },
    { key: 'pricePerDay', label: 'Price/Day', isVisible: true },
  ...
  const renderCarRow = (car: CarType, visibleColumns: ColumnConfig[]) => {
        ...
        case 'actions':
          return (
            <td key={col.key} className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium flex gap-2 justify-end">
              <button onClick={() => handleEdit(car)} className="text-indigo-600 hover:text-indigo-900">
                <Edit size={16} />
              </button>
              <button onClick={() => setShowDeleteConfirm(car.id)} className="text-red-600 hover:text-red-900">
                <Trash2 size={16} />
              </button>
            </td>
          );
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Cars Table with Column Selection */}
      <AdminTable
        tableKey="admin-cars"
        columns={carColumns}
        data={filteredCars}
