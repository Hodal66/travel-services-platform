...
//     filterCars(category, priceRange);
//   };

//   const handlePriceFilter = (range: string) => {
//     setPriceRange(range);
//     filterCars(selectedCategory, range);
//   };

//   const filterCars = (category: string, range: string) => {
//     let filtered = cars;
...
//         switch (range) {
//           case 'Under $50':
//             return car.pricePerDay < 50;
//           case '$50-$100':
//             return car.pricePerDay >= 50 && car.pricePerDay <= 100;
//           case '$100-$150':
//             return car.pricePerDay >= 100 && car.pricePerDay <= 150;
//           case 'Over $150':
//             return car.pricePerDay > 150;
//           default:
//             return true;
//         }
//       });
...
//             <h1 className="text-4xl font-bold mb-4">Premium Car Rentals</h1>
//             <p className="text-xl text-blue-100">
//               Find the perfect vehicle for your journey with our premium fleet
//             </p>
//           </div>
//         </div>
//       </div>
...
//           {filteredCars.map((car) => (
//             <div key={car.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
//               {/* Car Image */}
...
//                 <p className="text-gray-600 mb-4">{car.year} • {car.location}</p>
