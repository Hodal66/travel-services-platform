...
import { Star, Bed, Bath, Square, MapPin, ArrowRight, DollarSign } from 'lucide-react';
import { sampleProperties } from '@/data/sampleData';
...
const RealEstatePage: React.FC = () => {
  ...
  const filterProperties = (type: string, listingType: string, range: string) => {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProperties.map((property) => (
            <div key={property.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              {/* Property Image */}
